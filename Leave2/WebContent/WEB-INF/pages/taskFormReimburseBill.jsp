...
<body>
 	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
		  	<td>
                    <form action="../workflow/submitTask?taskId=${taskId}&id=${object.id}&formName=ReimburseBill" method="POST">               
			  		<div align="left" class="STYLE21">
				 		报销金额:${object.input }<br/>
				 		报销内容:${object.content }<br/>
				 		备注:${object.remark }<br/>
				 		批&emsp;&emsp;注:<input type="text" name="comment" /><br/>				 		
			 		</div>
			 		<!-- 使用连线的名称作为按钮 -->
			 		<c:forEach items="${outcomeList}" var="p">
				 				<input type="submit" name="outcome" value="${p}" class="button_ok"/>
				    </c:forEach>
			 	</form>
		  	</td>
		  </tr>
			        ...
			        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			          <tr>
			            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			              <tr>
			                <td width="6%" height="19" valign="bottom"><div align="center"><img src="${pageContext.request.contextPath }/images/tb.gif" width="14" height="14" /></div></td>
			                <td width="94%" valign="bottom"><span class="STYLE1">显示报销申请的批注信息</span></td>
			              </tr>
			            </table></td>
			            <td><div align="right"><span class="STYLE1">
			              </span></div></td>
